...
from .params_parse_tb import params_parse_tb
from .params_parse_hb import params_parse_hb
from .. import get_conditions


def parse_transformer_conditions(transformer, ex_table, apis):
    ...
    if "@tb" in transformer or "@hb" in transformer:
        ...
        if "@tb" in transformer:
            ...
            condition1_2 = params_parse_hb(apis)  # 得到 {列: 字符串} 形式的条件  {"day": "2020-01-01,2020-01-02"}
        code, msg, condition1_2 = get_conditions(ex_table, condition1_2)
        if code != 200:
            return code, msg, {}
