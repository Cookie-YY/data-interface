...
############################## 数据库配置 ##############################
# 分析库：业务表和码表的位置
FX_DB = 'mysql+pymysql://root:Beidas0ft@39.107.240.28:3307/pt_dev_dabot_cq'
...
# 指标库：指标表的位置
# ZB_DB = 'mysql+pymysql://root:Beidas0ft@39.107.240.28:3306/pt_dev_dabot_cq_zb'
# ZB_DB = 'mysql+pymysql://root:Beidas0ft@127.0.0.1:3306/pt_dev_dabot_cq_zb'
# ZB_DB = 'mysql+pymysql://root:Beidas0ft@10.1.2.35:3306/dabot_cq_zb'
ZB_DB = 'mysql+pymysql://root:Beidas0ft@10.1.2.35:3306/cqdp_zb'
...
CACHE_TYPE = "redis"
# CACHE_TYPE = "null"
CACHE_REDIS_HOST = '10.1.2.35'
CACHE_REDIS_PORT = 6379
CACHE_REDIS_DB = '1'
CACHE_REDIS_PASSWORD = 'Beidas0ft'
...
LEVEL_AUTH = False   # 为True时必须指定 LEVEL_AUTH_COOKIE
...
CUS_PARAM_TRANS = ["wx_map", "xfbm_godown", "zrdw_godown", "djjg_qhauth", "xfbm_qhauth", "zrdw_qhauth", "xfbmsearch_qhauth", "zrdwsearch_qhauth", "find_qh_from_xfbm"]
