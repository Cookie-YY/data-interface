...
class Bmsllv(Extension):
    ...
    def __init__(self, apis_copy, apis):
        super(Bmsllv, self).__init__(apis_copy, apis)  # 执行父类方法，获得self.apis/self.apis_copy
    ...
    def before_search(self):
        ...
        before_waiting_for_search = [
            {"table": table_yp, "db_engine": "fx_db", "columns": columns_yp, "conditions": [self.apis]},
            {"table": table_wp, "db_engine": "fx_db", "columns": columns_wp, "conditions": [self.apis]},
        ]
